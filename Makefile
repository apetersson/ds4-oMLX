...
clean:
	...
	rm -f ds4 ds4-server ds4-bench ds4-eval ds4-agent ds4_cpu ds4_native ds4_server_test ds4_test ds4_agent_test gguf-tools/quality-testing/score_official gguf-tools/quality-testing/score_official.o speed-bench/metal_decode_schedule_bench speed-bench/metal_prefill_variant_bench speed-bench/*.o tests/test_q4k_dot tests/test_mxfp4_dot tests/test_mxfp4_metal tests/test_mxfp4_rocm tests/test_mxfp4_cuda tests/test_metal_session_batch tests/test_metal_moe_prefill tests/test_qwen4_moe_mm_specialize tests/test_metal_dense_mpp tests/test_glm53_kda tests/test_glm53_kda_rocm tests/test_glm53_vision_engine tests/test_glm53_vision_prompt tests/test_deepseek4_vision_image tests/test_prompt_prefix tests/test_gpu_xdev tests/test_gpu_model_cache tests/test_gpu_lookup_cache_strict tests/test_engine_mgpu_refusal tests/test_engine_mgpu_runtime tests/test_engine_correctness tests/test_sampling tests/test_cuda_session_batch tests/test_cuda_mixed_batch tests/*.o *.o tests/cuda_long_context_smoke tests/cuda_long_context_smoke.o
	rm -f tests/test_qwen4_kernels tests/test_qwen4_vision
	rm -f $(QWEN4_HOST_TEST) $(QWEN4_SPEC_TEST)

ifeq ($(UNAME_S),Darwin)
# Optional independent reference fixtures: Python environment needs numpy and gguf.
QWEN4_EXTRA_FIXTURES ?= tests/.qwen4-extra-fixtures
PYTHON ?= python3
.PHONY: test-qwen4-extra-quants

tests/test_qwen4_extra_quants: tests/test_qwen4_extra_quants.c ds4_gpu.h ds4_metal.o ds4_image.o
	$(CC) $(CFLAGS) -I. -o $@ $< ds4_metal.o ds4_image.o $(METAL_LDLIBS)

tests/test_qwen4_extra_quants_cpu: tests/test_qwen4_extra_quants_cpu.c ds4.c ds4_image.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o
	$(CC) $(CFLAGS) -I. -o $@ $< ds4_image.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o $(LDLIBS)

test-qwen4-extra-quants: tests/test_qwen4_extra_quants tests/test_qwen4_extra_quants_cpu
	$(PYTHON) tests/qwen4_extra_quant_fixtures.py $(QWEN4_EXTRA_FIXTURES)
	./tests/test_qwen4_extra_quants_cpu $(QWEN4_EXTRA_FIXTURES)
	./tests/test_qwen4_extra_quants $(QWEN4_EXTRA_FIXTURES)
endif
